...
},{"@firebase/storage":"node_modules/@firebase/storage/dist/index.esm.js"}],"download.js":[function(require,module,exports) {
"use strict";
...
var builder = function builder(tag) {
  var classes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
  var content = arguments.length > 2 ? arguments[2] : undefined;
  var domNode = document.createElement(tag);

  if (classes.length) {
    var _domNode$classList;

    (_domNode$classList = domNode.classList).add.apply(_domNode$classList, _toConsumableArray(classes));
  }
...
function download(selector) {
  ...
  var preview = builder('div', ['preview']);
  var open = builder('button', ['btn'], 'Открыть');
  var downLoad = builder('button', ['btn', 'primary'], 'Загрузить');
  ...
  var takenFile = function takenFile(event) {
    ...
    files.forEach(function (file) {
      ...
      reader.onload = function (ev) {
        ...
        preview.insertAdjacentHTML('afterbegin', "\n                <div class=\"preview-image\">\n                <div class=\"preview-delete\" data-name=\"".concat(file.name, "\">&times;</div>\n                <img src=\"").concat(src, "\" alt=\"").concat(file.name, "\">\n                <div class=\"preview-info\">\n                    <span>").concat(file.name, "</span>\n                    <span>").concat(bytesTo(file.size), "</span>\n                </div>\n                </div>\n             "));
      };
  ...
  var deleteChooses = function deleteChooses(event) {
  ...
  var downLoadImage = function downLoadImage() {
    preview.querySelectorAll('.preview-delete').forEach(function (e) {
      return e.remove();
    });
...
},{"firebase/app":"node_modules/firebase/app/dist/index.esm.js","firebase/storage":"node_modules/firebase/storage/dist/index.esm.js","./download":"download.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
